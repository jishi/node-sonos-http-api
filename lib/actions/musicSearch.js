...
try {var settings=require('../../settings.json');} catch(e){var settings = '';}
...
function getMetadata(service, type, id, name, title) {
  const token = serviceTokens[service] + (((service == 'deezer') && (settings!='') && (settings.deezer != undefined))?settings.deezer.username:'');
